...
async def api_create_blog(request, *, name, summary, content):
    logging.info('york----------------------发表日志API')
    logging.info('york----------------------request', request.__user__)
